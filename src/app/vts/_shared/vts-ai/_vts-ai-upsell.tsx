export default function VtsAiUpsell() {
  return (
    <div className="via-vts-purple-800 animate-upsell-banner-gradient border-vts-purple-900 mb-2 flex flex-col gap-2 rounded-lg border bg-radial-[at_50%_-75%] from-pink-800 to-black p-4 text-white/90">
