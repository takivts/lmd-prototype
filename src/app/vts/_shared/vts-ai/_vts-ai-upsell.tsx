export default function VtsAiUpsell() {
  return (
    <div className="layered-shadow animate-ai-linear-gradient mb-2 flex flex-col gap-2 rounded-2xl bg-[linear-gradient(45deg,var(--color-vts-ai-light)_0%,var(--color-vts-ai-medium)_25%,var(--color-vts-ai-dark)_75%,var(--color-vts-ai-gray)_200%)] bg-[length:400%_400%] p-4 text-white/90">
