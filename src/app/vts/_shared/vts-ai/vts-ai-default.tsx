...
import VtsAiAssistant from "./vts-ai-assistant";
...
>(({ className, isOpen }, ref) => {
  ...
  const { vtsAiData, setVtsAiContentType, isUpsell, isPromptError, showChatInput, vtsAiPersona, setVtsAiPersona } = useAppContext();
  ...
  const resetConversation = () => {
    ...
    // Reset to Analyst persona when resetting
    setVtsAiPersona("Analyst");
  };
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {showChatInput && vtsAiPersona === "Analyst" && (
